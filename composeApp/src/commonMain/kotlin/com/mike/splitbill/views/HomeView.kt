package com.mike.splitbill.views
...
import com.mike.splitbill.components.MainCard
import com.mike.splitbill.components.MainIcon
import com.mike.splitbill.components.MainRow
import com.mike.splitbill.ui.theme.colors
       ...
       MainCard("Total Bill Amount"){
           ...
           Row (
               ...
               MainIcon("down", Icons.Default.ArrowCircleDown){
                   if (numberPerson > 1) numberPerson--
               }
           ...
           Button(onClick = {
               if (!amount.isEmpty()){
                   ...
                   totalByPersons = calculate(amount,selectedTip,numberPerson)
               }
               focusManager.clearFocus()
           }){
               Text("Calculate")
